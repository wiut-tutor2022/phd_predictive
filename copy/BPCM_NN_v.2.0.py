...
df = pd.read_csv('../Classroom_attendance_Prediction/2017_sem2_attendance_data4.csv')
...
if __name__ == "__main__":
    ...
    with open('../Classroom_attendance_Prediction/Ratios_Export.csv') as csvfile:  # Testing Company Input Data
