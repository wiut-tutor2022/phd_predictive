...
# Load the datasets
training_data_cols = np.array(read_csv('Training_Data_2019_45.csv').columns.values.tolist())
training_data = read_csv('Training_Data_2019_45.csv', header=0).values
training_output = read_csv('Training_Output_2019.csv', header=0).T.values
